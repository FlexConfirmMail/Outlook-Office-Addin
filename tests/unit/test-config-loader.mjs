...
test_toDictionaryCommon.parameters = {
  ...
  "EnableAppointmentWarning=True": {
    str: "EnableAppointmentWarning=True",
    expected: { "EnableAppointmentWarning": true },
  },
  ...
  "EnableAppointmentWarning=1": {
    str: "EnableAppointmentWarning=1",
    expected: { "EnableAppointmentWarning": true },
  },
  ...
  "EnableAppointmentWarning=on": {
    str: "EnableAppointmentWarning=on",
    expected: { "EnableAppointmentWarning": true },
  },
...
test_merge.parameters = {
  ...
  "fix all parameters": {
    left: {
      ...
      unsafeDomains: ["unsafeDomain_left"],
      unsafeFiles: ["unsafeFile_left"],
      commonString: "CountEnabled = true\nCountAllowSkip = true\nSafeBccEnabled = true\nMainSkipIfNoExt = true\nEnableAppointmentWarning = true\nSafeNewDomainsEnabled = true\nCountSeconds = 3\nSafeBccThreshold = 4\nDelayDeliveryEnabled = true\nDelayDeliverySeconds = 60\nFixedParameters = CountEnabled,CountAllowSkip,SafeBccEnabled,MainSkipIfNoExt,EnableAppointmentWarning,SafeNewDomainsEnabled,CountSeconds,SafeBccThreshold,DelayDeliveryEnabled,DelayDeliverySeconds,TrustedDomains,UnsafeDomains,UnsafeFiles",
      trustedDomainsString: "trustedDomain_left",
      unsafeDomainsString: "unsafeDomain_left",
      unsafeFilesString: "unsafeFile_left",
    },
