...
test_toDictionaryCommon.parameters = {
  ...
  "EnableAppointmentConfirmation=True": {
    str: "EnableAppointmentConfirmation=True",
    expected: { "EnableAppointmentConfirmation": true },
  },
  ...
  "EnableAppointmentConfirmation=1": {
    str: "EnableAppointmentConfirmation=1",
    expected: { "EnableAppointmentConfirmation": true },
  },
  ...
  "EnableAppointmentConfirmation=on": {
    str: "EnableAppointmentConfirmation=on",
    expected: { "EnableAppointmentConfirmation": true },
  },
...
test_merge.parameters = {
  ...
  "fix all parameters": {
    left: {
      ...
      unsafeDomains: ["unsafeDomain_left"],
      unsafeFiles: ["unsafeFile_left"],
      commonString: "CountEnabled = true\nCountAllowSkip = true\nSafeBccEnabled = true\nMainSkipIfNoExt = true\nEnableAppointmentConfirmation = true\nSafeNewDomainsEnabled = true\nCountSeconds = 3\nSafeBccThreshold = 4\nDelayDeliveryEnabled = true\nDelayDeliverySeconds = 60\nFixedParameters = CountEnabled,CountAllowSkip,SafeBccEnabled,MainSkipIfNoExt,EnableAppointmentConfirmation,SafeNewDomainsEnabled,CountSeconds,SafeBccThreshold,DelayDeliveryEnabled,DelayDeliverySeconds,TrustedDomains,UnsafeDomains,UnsafeFiles",
      trustedDomainsString: "trustedDomain_left",
      unsafeDomainsString: "unsafeDomain_left",
      unsafeFilesString: "unsafeFile_left",
    },
